...
django.settings_module("ellis_act.settings")
from django.conf import settings

from ellis_act.settings.production import (
    AWS_BUCKET_NAME,
...
def grunt_build():
    ...
    """
    local('cd ellis_act && grunt build')
...
def build():
    ...
    local('python manage.py build \
        --skip-static --settings=ellis_act.settings.production')
...
def unbuild():
    ...
    local('python manage.py unbuild \
        --settings=ellis_act.settings.production')
