"""
Django settings for ellis_act project.
...
SECRET_KEY = '8501qdvem_p%%ut908ejb@66ldum%%x-=t1kzv=4jl$ko+36yj'
...
ROOT_URLCONF = 'ellis_act.urls'

WSGI_APPLICATION = 'ellis_act.wsgi.application'
